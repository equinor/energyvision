  ...
  switch (pattern) {
    case 1:
      return {
        ...
        highlight: 'highlight:text-energy-red-100',
      }
    case 2:
      return {
        ...
        highlight: 'highlight:text-slate-80',
      }
    case 3:
      return {
    ...
    case 6:
      return {
        ...
        dark: true,
        highlight: 'highlight:text-orange-50 dark:highlight:text-orange-50',
      }
    case 7:
      return {
        background: 'Mid Blue',
        backgroundUtility: 'bg-blue-50',
        highlight: 'highlight:text-yellow-50 dark:highlight:text-yellow-50',
    ...
    case 8:
      return {
        ...
        highlight: 'highlight:text-white-100 dark:highlight:text-white-100',
        dark: true,
      }
    case 9:
      return {
    ...
    case 10:
      return {
        ...
        highlight: 'highlight:text-blue-50',
      }
    case 11:
      return {
        textUtility: '*:text-slate-80',
    ...
    case 12:
      return {
        textUtility: '*:text-white-100',
        highlight: 'highlight:text-white-100',
        dark: true,
      }
    case 13:
      return {
