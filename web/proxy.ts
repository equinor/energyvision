...
export const config = {
  ...
  matcher:
    '/((?!api/draft|api/newsletter-rss|api/revalidate-sanity|api/rss|api/update-algolia-indexes|content/dam|_next|favicon.ico|__nextjs|__nextjs_original-stack-frame|__nextjs_launch-editor|.well-known|legacy|content/dam/|etc.clientlibs/|sitemap.xml|robots.txt).*)',
};
