'use client'
import { createContext, type RefObject, useState } from 'react'
...
export const PaginationContextProvider = ({
  ...
  const [resultsRef] = useState<RefObject<HTMLDivElement | null> | undefined>(
    defaultRef,
  )

  return (
    <PaginationContext.Provider value={{ resultsRef }}>
      {children}
