...
import type { PromotionData, NewsCardData, TopicCardData } from '../../../types/types'
...
const getCards = (articles: NewsCardData[], pages: TopicCardData[]) => {
...
const Promotion = ({ data }: { data: PromotionData }) => {
  const { title, ingress, promotion } = data
  // const { articles = [], pages = [] } = data.promotion

  const cards = getCards(promotion)
