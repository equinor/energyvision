...
import type { EventCardDataV2, EventPromotionSettings } from '../../../types/types'
...
const MultipleEventCardsV2 = ({ data, hasSectionTitle, eventPromotionSettings }: MultipleEventCardsProp) => {
...
export default MultipleEventCardsV2
