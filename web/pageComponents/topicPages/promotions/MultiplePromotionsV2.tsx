...
import MultipleEventCardsV2 from './MultipleEventCardsV2'
...
const MultiplePromotionsV2 = ({
  data,
  variant,
  hasSectionTitle,
  eventPromotionSettings,
}: {
  data: CardData[] | PeopleCardData[] | EventCardDataV2[]
  ...
  if (variant === 'promoteEvents') {
    return (
      <MultipleEventCardsV2
        data={data as EventCardDataV2[]}
...
export default MultiplePromotionsV2
