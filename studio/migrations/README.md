...
1. Inside studio folder run `pnpx sanity migration create "Issue <ISSUE_NO>"` to create a migration script folder. You can choose the appropriate template or start with a basic one.
