  ...
  return (
    <Box>
      ...
      <span style={{ display: 'block', marginTop: '25px' }}>
        <Text>
          This component will automatically display up to date Equinor stock
          values from the OSE and NYSE. No configuration is required.
        </Text>
      </span>
    </Box>
  )
...
export default {
  title: 'Stock values',
  description:
    'This component will automatically display up to date Equinor stock values from the OSE and NYSE.',
  name: 'stockValuesApi',
  type: 'object',
  fieldsets: [
    {
  ...
  fields: [
    {
      ...
      title: 'Title',
      description:
        'The stock values should have a heading, but can be hidden below',
    },
    defineField({
      name: 'hideTitle',
      type: 'boolean',
