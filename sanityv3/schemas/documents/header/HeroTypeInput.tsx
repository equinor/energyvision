...
import { type Role, type StringInputProps, set, type TitledListValue, useCurrentUser } from 'sanity'

const restrictedHeroTypes = ['loopingVideo', 'backgroundImage']
...
export default function HeroTypeInput(props: StringInputProps) {
  ...
  const herotypes = (options?.list as Array<TitledListValue<'string'>>)?.filter((option) => {
