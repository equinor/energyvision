  ...
  return (
    <svg width={width} xmlns="http://www.w3.org/2000/svg" version="1.0" height={height}>
      ...
      <g id="rays">
        ...
        />
        <use xlinkHref="#ray1" transform="rotate(22.5 400,250)" />
        <use xlinkHref="#ray1" transform="rotate(45 400,250)" />
        <use xlinkHref="#ray1" transform="rotate(67.5 400,250)" />
        <path
          id="ray2"
          fill="#85340a"
        ...
        />
        <use xlinkHref="#ray2" transform="rotate(22.5 400,250)" />
        <use xlinkHref="#ray2" transform="rotate(45 400,250)" />
        <use xlinkHref="#ray2" transform="rotate(67.5 400,250)" />
      </g>
      <use xlinkHref="#rays" transform="rotate(90 400,250)" />
      <use xlinkHref="#rays" transform="rotate(180 400,250)" />
      <use xlinkHref="#rays" transform="rotate(270 400,250)" />
      ...
      />
      <use xlinkHref="#uppalpebra" transform="matrix(-1 0 0 1 800.25 0)" />
      <use xlinkHref="#eyebrow_nose" transform="matrix(-1 0 0 1 800.25 0)" />
      <use xlinkHref="#pupil" transform="translate(18.862)" />
      <use xlinkHref="#lowpalpebra" transform="matrix(-1 0 0 1 800.25 0)" />
      <path
      ...
      />
      <use xlinkHref="#loweyecontour" transform="translate(-19.181)" />
